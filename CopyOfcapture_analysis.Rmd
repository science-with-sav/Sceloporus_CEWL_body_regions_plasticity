...
CEWL_data_full <- CEWL %>%
  ...
  mutate(ctemp_adj_CEWL = TEWL_g_m2h/(cloacal_temp_C))
...
CEWL_data_full %>% 
  ...
  theme_classic() + 
  xlab("Body Region") + 
  ylab(bquote('Cloacal Temp-AdjustedCEWL (g / '*m^2~h*')')) + 
  annotate("text", x = 1, y = 64, label = "a", size = 6) +
  annotate("text", x = 2, y = 77, label = "b", size = 6) +
  annotate("text", x = 3, y = 95, label = "b", size = 6) +
  annotate("text", x = 4, y = 65, label = "a", size = 6) +
...
# export figure
ggsave(filename = "CEWL_region_fig2.jpeg",
       plot = CEWL_region_fig2,
       path = "./final_figures",
       device = "jpeg",
       dpi = 1200,
       width = 6, height = 4)

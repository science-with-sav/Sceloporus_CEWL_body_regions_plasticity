...
morpho_blood_dat <- read.csv("./data/Herpetology_Data.csv",
  ...
  dplyr::mutate(collect_date_time = as.POSIXct(paste(date, collect_time), "%m/%d/%y %H:%M"),
...
SAVANNAH: make date-time variable, interpolate weather data to match it, then join
...
### Weather Data
```{r}
Weather_April_05 <- read.csv("./data/4_5Weather.csv", sep = ";")
Weather_April_19 <- read.csv("./data/4_19Weather.csv", sep = ";")
Weather_May_03 <- read.csv("./data/5_3Weather.csv", sep = ";")
Weather_May_10 <- read.csv("./data/5_10Weather.csv", sep = ";")
Weather_May_17 <- read.csv("./data/5_17Weather.csv", sep = ";")

# Join all of the weather
Weather_full <- full_join(Weather_April_05, Weather_April_19)
Weather_full <- full_join(Weather_full, Weather_May_03)
Weather_full <- full_join(Weather_full, Weather_May_10)
Weather_full <- full_join(Weather_full, Weather_May_17) %>%
...
# Potential normality violation
hist(CEWL_plus$TEWL_g_m2h)

# Center by SD scaling
CEWL_scaled <- CEWL_plus
CEWL_scaled$TEWL_scaled <- scale(CEWL_scaled$TEWL_g_m2h, center=T, scale=T)

...
# export
write.csv(morpho_blood_dat, "capture_hydration.csv")
```
...
```{r}
write.csv(CEWL, "capture_CEWL.csv")
```
...
```{r}
write.csv(all_data_long, "capture_data_long.csv")
write.csv(all_data_wide, "capture_data_wide.csv")
```

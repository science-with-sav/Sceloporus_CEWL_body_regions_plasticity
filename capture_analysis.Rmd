...
ggarrange(cap_temp_CEWL, CEWL_ctemp_fig, 
          CEWL_abshum_fig, CEWL_mass_fig, 
          sorad_CEWL_plot, CEWL_legend,
          ncol = 2, nrow = 3
          ) -> CEWL_multi_fig
CEWL_multi_fig
# export figure
...
# export 
write.csv(osml_best_mod_vals, "./best models/osml_best_mod_vals.csv")
```
...
CEWL_best_mod <- summary(CEWL_mod3)
# extract stats table from summary object
CEWL_best_mod_vals <- data.frame(CEWL_best_mod$coefficients)
# export 
write.csv(CEWL_best_mod_vals, "./best models/CEWL_best_mod_vals.csv")
```
...
CEWL_mod_res <- CEWL_mod_dat %>%
  mutate(y_hat = predict(CEWL_mod3),
         e = residuals(CEWL_mod3))
```
...
CEWL_mod3_t <- lme4::lmer(data = CEWL_mod_dat,
                          log(TEWL_g_m2h) ~
                            region * (mass_g +
                                     temp_C_interpol +
                                     abs_humidity_g_m3_interpol) +
...
CEWL_best_t_mod <- summary(CEWL_mod3_t)
# extract stats table from summary object
CEWL_best_t_mod_vals <- data.frame(CEWL_best_t_mod$coefficients)
# export 
write.csv(CEWL_best_t_mod_vals, "./best models/CEWL_best_mod_t_vals.csv")
```

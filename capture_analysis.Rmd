...
```{r hct model 10}
hct_mod10 <- lm(data = morpho_blood_SMI,
                          # response variable
                          hematocrit_percent ~ 
                          # predictor variables
                          VPD_kPa_int +
...
```{r hct model 11}
hct_mod11 <- lm(data = morpho_blood_SMI,
                          # response variable
                          hematocrit_percent ~ 
                          # predictor variables
                          sex_M_F) 
...
hct_models <- list(hct_mod4, hct_mod5, hct_mod6, hct_mod7, 
                   hct_mod8, hct_mod9, hct_mod10, hct_mod11, 
                   hct_mod_null)

#specify model names
hct_mod_names <- c('(model 4) ~ ', 
                       '(model 5) ~ ', 
                       '(model 6) ~ ',
                       '(model 7) ~ ', 
                       '(model 8) ~ ', 
...
write.csv(broom.mixed::tidy(hct_mod4), 
          "./best_models/osml_best_mod3.csv")
```

...
CEWL_data_full %>% 
  ...
  annotate("text", x = 2, y = 62, label = "b", size = 6) +
  annotate("text", x = 3, y = 105, label = "b", size = 6) +
  annotate("text", x = 4, y = 92, label = "a", size = 6) +
...
# redo best model
# model 3
CEWL_mod3_adj <- lme4::lmer(data = CEWL_mod_dat2,
                        TEWL_g_m2h ~
                         region * (mass_g +
                                     temp_C_interpol +
                                     abs_humidity_g_m3_interpol) +
...
CEWL_best_mod <- summary(CEWL_mod3_adj)
# extract stats table from summary object
